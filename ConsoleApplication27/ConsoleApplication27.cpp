...
class Adress
{
    ...
    int postal_index;
public:
    Adress(string country = "Ukraine", string region = "Odesa", string city = "Odesa", string street = "Nevskogo", int house_number = 55, int flat_number = 12, int postal_index = 65016)
    {
